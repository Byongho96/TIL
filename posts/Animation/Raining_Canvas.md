...
[Github 소스코드](https://github.com/Byongho96/TIL/tree/master/src/components/raining-canvas)

강의의 자바스크립트 코드를, 약간만 커스텀해서 리액트 컴포넌트로 바꿨다.  
그 과정에서 특별히 언급할 만한 부분이 2개가 있다.
